...
$(function(){
	...
	var userStatisticsTipsContent = 
		'<p>会员统计，将针对<b>本门店及其下上级管理门店</b>，包括<b>微信会员</b>及<b>手机会员</b>的会员做数据统计分析。冻结状态会员也将统计在内，但不包括下级自主经营门店的会员数据。</p>'+
	...
	// 累计会员数tips
	var totalUserTipsContent = 
		'<p>• 累计会员总数，指<b>本门店及其下上级管理门店</b>，包括<b>微信会员</b>及<b>手机会员</b>的会员总数。冻结状态会员也将统计在内，但不包括下级自主经营门店的会员数据。</p>'+
		'<p>• 微信会员，指商户将公众号授权给舞象云后，在微信用户访问商城时，系统为微信用户自动注册的会员。微信会员需完成手机号绑定操作后，才可进行下单、抽奖等操作。已关注公众号的微信会员将能收到通过舞象云精准推送的公众号推文。</p>'+
		'<p>• 手机会员，指用户通过微信会员绑定，或直接通过手机号注册的会员。</p>';
	...
	// 累计客单价tips
	var everyPersonPriceTipsContent = 
		'<p>指标统计会员客单价为成交会员客单价。</p>'+
	...
	// 七天新增会员tips
	var days7NewUsersTipsContent = 
		'<p>• 7日新增会员，指<b>本门店及其下上级管理门店</b>，包括<b>微信会员</b>及<b>手机会员</b>的7日（含今日）新增注册会员总数。</p>'+
	...
	// 会员漏斗tips
	var userFunnelTipsContent =
		'<p>会员漏斗展示各节点（绑定手机、消费下单）会员转化情况。</p>'+
		'<p>• 全部会员（微信+手机号）=100%</p>'+
		'<p>• 绑定手机=绑定手机号会员/全部会员*100%</p>'+
...
//	门店新增会员***************************************************************************************************
	timesNewUser
	var timesNewUserChart = echarts.init(document.getElementById('timesNewUser'));
	...
	setTimeout(function(){
		...
		// 设置门店会员统计相关数据---------------------------------------------------------
		var shopUsersStatisticsData = [],
				shopPhoneUsersStatisticsData = [];
		var baseShopUsersStatistics1 = 100,
				baseShopUsersStatistics2 = 100;
		for (var i = 0; i < 200; i++) {
