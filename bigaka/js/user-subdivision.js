...
// 会员地图
	...
	var convertedData = [
	    convertData(userCityData),
	    convertData(userCityData.sort(function (a, b) {
	        return b.value - a.value;
	    }).slice(0, 6)),
			userCityData.sort(function (a, b) {
	        return b.value - a.value;
	    }).slice(0, 21)
	];
	userCityChart.setOption({
	    ...
	    yAxis: {
	        ...
	        axisLabel: {interval: 0, textStyle: {color: '#888888'}},
